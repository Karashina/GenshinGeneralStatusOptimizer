...
def objective(x):
    ...
    return -(((251+weaponbase)*(1+a)*mvaps+876*(1+h)*mvdps)*(1+r*d)+stps*4340.56*(1+16*e/(e+2000)))
...
print("コピペ用:",f"{result.x[1]:.4f}",",",f"{result.x[2]:.4f}",",",f"{result.x[3]:.4f}",",",f"{result.x[4]:.4f}")